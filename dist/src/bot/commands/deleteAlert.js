...
const supabase_2 = require("../../integrations/supabase");
...
function handleDeleteAlertCommand(chat, user, args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const dbUser = yield (0, supabase_2.getUserByTelegramId)(String(user.id));
            if (!alert) {
                yield (0, telegram_1.sendTelegramMessage)(Object.assign({ chat_id: chat.id, text: `⚠️ Alert with ID \`${alertId}\` not found.`, parse_mode: 'Markdown' }, (dbUser && dbUser.onboarded ? { reply_markup: menu_1.mainMenuKeyboard } : {})));
                return;
            }
            ...
            yield (0, telegram_1.sendTelegramMessage)(Object.assign({ chat_id: chat.id, text: `✅ Alert for ${alert.pair} ${alert.direction} ${alert.target_price} has been deleted.`, parse_mode: 'Markdown' }, (dbUser && dbUser.onboarded ? { reply_markup: menu_1.mainMenuKeyboard } : {})));
